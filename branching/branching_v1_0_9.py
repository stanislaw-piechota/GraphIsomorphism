...
# early terminating branching based on branching_v1_0_4.py, augmented with process parallelization

def aut_fast_multicore_branching(path: str, do_aut_count: bool = True) -> IsomorphismAnalResult:
...
if __name__ == "__main__":
    ...
    create_report(paths, {
        'aut_fast_multicore_branching': aut_fast_multicore_branching,
    ...
    }, out_path='../docs/branching-v1_0_3-vs-v1_0_4-vs-v1_0_5-vs-v1_0_6-vs-v1_0_7-vs-v1_0_8-v1_0_9.tex')
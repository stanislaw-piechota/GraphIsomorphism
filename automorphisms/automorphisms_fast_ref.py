...
from colorref.colorref_v2_0_0 import is_balanced, is_bijection, fast_solve_colorref_transform, MIN_COLOR
from graphs.graph_io import load_graph
from orchestration.dataclasses import AutomorphismsAnalResult
from .automorphisms import AutoAnal, _AutSearchContext, _extract_permutation, is_member, compute_order


# branching based on branching_v1_0_3.py, but using colorref 2_0_0
def _generate_automorphism(d_seq: list, i_seq: list, ctx: _AutSearchContext, is_trivial_branch: bool) -> bool:
    ...
    if not is_balanced(ctx.g, ctx.h, coloring):
        return False
